        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiryMonth = table.Column<int>(maxLength: 2, nullable: false),
                    ExpiryYear = table.Column<int>(maxLength: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankResponseId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.BankResponseId,
                        principalTable: "BankResponses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentDetails_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentDetails_AspNetUsers_MerchantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentDetails_Identifier",
                table: "PaymentDetails",
                column: "Identifier",
                unique: true,
